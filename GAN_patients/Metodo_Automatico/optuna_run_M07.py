...
result_path = "/home/deepfake/DysarthricGAN/M07/OptunaResultsM07"
os.makedirs(result_path, exist_ok=True)    

dataset_path = "/home/deepfake/DysarthricGAN/M07/M07_MEL_SPEC"
...
def objective(trial):
    ...
    best_param = best_d_all #+ best_diff) / 2
    ...
    global_log_path = os.path.join(result_path, "M07_best_param.txt")
    with open(global_log_path, "a") as f:
        f.write(log_line)

    global_log_path_2 = os.path.join(result_path, "M07_best_distance.txt")
...
def main():
    ...
    parser.add_argument("--study_name", type=str, default="DysarthricGAN_M07_Optuna", help="Nome dello studio Optuna")
